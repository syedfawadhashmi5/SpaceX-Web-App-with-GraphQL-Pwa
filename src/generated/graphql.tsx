...
export type LanchInfoQueryVariables = Exact<{
  id?: Maybe<Scalars['String']>;
}>;


export type LanchInfoQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LanchInfoDocument = gql`
...
/**
 * __useLanchInfoQuery__
 *
 * To run a query within a React component, call `useLanchInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLanchInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLanchInfoQuery(baseOptions?: Apollo.QueryHookOptions<LanchInfoQuery, LanchInfoQueryVariables>) {
        return Apollo.useQuery<LanchInfoQuery, LanchInfoQueryVariables>(LanchInfoDocument, baseOptions);
      }
export function useLanchInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LanchInfoQuery, LanchInfoQueryVariables>) {
          return Apollo.useLazyQuery<LanchInfoQuery, LanchInfoQueryVariables>(LanchInfoDocument, baseOptions);
        }
export type LanchInfoQueryHookResult = ReturnType<typeof useLanchInfoQuery>;
export type LanchInfoLazyQueryHookResult = ReturnType<typeof useLanchInfoLazyQuery>;
export type LanchInfoQueryResult = Apollo.QueryResult<LanchInfoQuery, LanchInfoQueryVariables>;